...
export declare type ModelDefinitionValue = PrimaryKey<any> | ModelValueTypeGetter | NullableProperty<any> | OneOf<any, boolean> | ManyOf<any, boolean> | NestedModelDefinition;
export declare type NestedModelDefinition = {
    [propertyName: string]: ModelValueTypeGetter | NullableProperty<any> | OneOf<any, boolean> | ManyOf<any, boolean> | NestedModelDefinition;
};
